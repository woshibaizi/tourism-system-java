...
public class AgentService {
    ...
    public Map<String, Object> regenerateDiary(Long userId, Map<String, Object> payload) {
        Map<String, Object> full = new LinkedHashMap<>(payload);
        full.putIfAbsent("user_id", String.valueOf(userId));
        return agentClient.regenerateDiary(full);
    }

    // ==================== 用户风格偏好 ====================

    public Map<String, Object> getStylePrefs(Long userId) {
        return agentClient.getStylePrefs(String.valueOf(userId));
    }

    // ==================== 对话式游记生成 & 一键发布 ====================

    public Map<String, Object> generateDiaryFromChat(Long userId, Map<String, Object> payload) {
        Map<String, Object> full = new LinkedHashMap<>(payload);
        full.putIfAbsent("user_id", String.valueOf(userId));
        return agentClient.generateDiaryFromChat(full);
    }

    public Map<String, Object> publishDiary(Long userId, Map<String, Object> payload) {
        Map<String, Object> full = new LinkedHashMap<>(payload);
        full.putIfAbsent("user_id", String.valueOf(userId));
        return agentClient.publishDiary(full);
    }

    public Map<String, Object> polishDiary(Long userId, Map<String, Object> payload) {
        Map<String, Object> full = new LinkedHashMap<>(payload);
        full.putIfAbsent("user_id", String.valueOf(userId));
        return agentClient.polishDiary(full);
    }

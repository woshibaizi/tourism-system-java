...
public class FacilityController {
    ...
    public Result<Page<SpotFacility>> listByPlace(
        ...
        wrapper.ne(SpotFacility::getType, "路口")
                .orderByAsc(SpotFacility::getType).orderByAsc(SpotFacility::getName);
    ...
    public Result<List<SpotFacility>> search(
        ...
        wrapper.ne(SpotFacility::getType, "路口")
                .and(w -> w.like(SpotFacility::getName, query)

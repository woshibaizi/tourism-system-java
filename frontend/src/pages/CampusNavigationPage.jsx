      ...
      <div className="flex gap-1 mb-8 border-b border-neutral-100">
        {[
          ...
          <button
            ...
            className={`px-6 py-3 font-sans text-xs uppercase tracking-widest border-b-2 transition-colors ${activeTab === t.key ? 'border-black text-black' : 'border-transparent text-muted hover:text-black'}`}
          >
            {t.label}
          </button>
        ))}

        ...
        <div className="flex gap-2">
          {['all', 'places', 'foods'].map((c) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-sans uppercase tracking-widest border transition-colors ${category === c ? 'border-black text-heading' : 'border-border text-muted hover:text-heading'}`}
            >
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {paginated.map((item) => (
              ...
              >
                <div className="aspect-[3/4] overflow-hidden mb-6 bg-accent-soft relative">
                  {item.image ? (

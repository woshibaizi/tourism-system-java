...
function PlacesPage() {
      ...
      <Card
        ...
        cover={
          <div style={{ 
            ...
            position: 'relative',
            overflow: 'hidden',
            background: 'linear-gradient(135deg, #c77d4b 0%, #b8945a 100%)',
          }}>
            {place.image ? (
              <img
                alt={place.name}
            ...
            {place.recommendBadge && (
              <div style={{
                ...
                background: place.matchScore >= 0.7 
                  ? 'linear-gradient(135deg, #c77d4b, #b8945a)' 
                  : place.matchScore >= 0.5 
                    ? 'linear-gradient(135deg, #b8945a, #8b7a5a)' 
                    : 'linear-gradient(135deg, #c77d4b, #e8b96d)',
                color: 'white',
                padding: '6px 12px',
                borderRadius: '20px',
                fontSize: 12,
      ...
      >
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ 
            ...
            marginBottom: 12,
            padding: '8px 12px',
            background: 'linear-gradient(135deg, #f5ebe0 0%, #e8e0d5 100%)',
            borderRadius: '10px',
          }}>
            <Rate 
              disabled 
          ...
          <div style={{ 
            ...
            <div style={{ 
              display: 'flex', 
              alignItems: 'center',
              background: 'linear-gradient(135deg, #f5ebe0 0%, #e8b96d 100%)',
              padding: '4px 8px',
              borderRadius: '8px',
            }}>
              <EyeOutlined style={{ fontSize: 12, color: '#c77d4b', marginRight: 4 }} />
              <span style={{ fontSize: 12, fontWeight: 500, color: '#c77d4b' }}>
                {place.clickCount || 0}
              </span>
            </div>
            ...
            {place.recommendRank && place.recommendRank <= 4 && (
              <div style={{
                background: 'linear-gradient(135deg, #e8b96d 0%, #c77d4b 100%)',
                color: 'white',
                padding: '4px 8px',
                borderRadius: '8px',
                fontSize: 11,
  ...
  return (
    <div className="content-wrapper" style={{ background: 'linear-gradient(135deg, #faf8f5 0%, #ede4d3 100%)', minHeight: '100vh' }}>
                ...
                >
                  <Option value="recommendation">
                    <span style={{ display: 'flex', alignItems: 'center' }}>
                      <StarOutlined style={{ marginRight: 8, color: '#e8b96d' }} />
                      个性化推荐
                    </span>
                  </Option>
      ...
      <Spin spinning={loading} tip={loading ? "正在为您个性化推荐..." : ""}>
        ...
        {!loading && places.length === 0 && (
          <div style={{ 
            ...
            <EnvironmentOutlined style={{ fontSize: 64, color: '#b8a99a', marginBottom: 16 }} />
            <Title level={4} style={{ color: '#b8a99a', margin: 0 }}>
              {isSearchMode ? '未找到相关场所' : '暂无场所数据'}
            </Title>
            <Text style={{ color: '#b8a99a', fontSize: 14 }}>
        ...
        <div style={{
          ...
          <Pagination
            ...
            showTotal={(total, range) => (
              <span style={{ color: '#4a3f35', fontSize: 14 }}>

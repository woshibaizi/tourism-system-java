...
function PlacesPage() {
    ...
    <Col xs={24} sm={12} md={8} lg={6} key={place.id}>
      <Card
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, #F7F4EF 0%, #F2EFE9 100%)',
        }}
        cover={
          <div style={{ 
            aspectRatio: '3/2', 
            position: 'relative',
            overflow: 'hidden',
            background: 'linear-gradient(135deg, #9B8E7E 0%, #7D7064 100%)',
          }}>
            {place.image ? (
              <img
                alt={place.name}
            ...
            {place.recommendBadge && (
              <div style={{
                ...
                background: place.matchScore >= 0.7 
                  ? 'linear-gradient(135deg, #9B8E7E, #7D7064)' 
                  : place.matchScore >= 0.5 
                    ? 'linear-gradient(135deg, #7D7064, #7D7064)' 
                    : 'linear-gradient(135deg, #9B8E7E, #8A9A8B)',
                color: 'white',
                padding: '6px 12px',
                borderRadius: '20px',
                fontSize: 12,
        ...
        actions={[
          <Button 
            ...
            style={{
              ...
              border: 'none',
              background: 'linear-gradient(135deg, #9B8E7E 0%, #7D7064 100%)',
              boxShadow: '0 2px 8px rgba(155, 142, 126, 0.25)',
            }}
          >
            查看详情
          </Button>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ 
            ...
            <div style={{ 
              display: 'flex', 
              alignItems: 'center',
              background: 'linear-gradient(135deg, #F2EFE9 0%, #8A9A8B 100%)',
              padding: '4px 8px',
              borderRadius: '8px',
            }}>
              <EyeOutlined style={{ fontSize: 12, color: '#9B8E7E', marginRight: 4 }} />
              <span style={{ fontSize: 12, fontWeight: 500, color: '#9B8E7E' }}>
                {place.clickCount || 0}
              </span>
            </div>
            ...
            {place.recommendRank && place.recommendRank <= 4 && (
              <div style={{
                background: 'linear-gradient(135deg, #8A9A8B 0%, #9B8E7E 100%)',
                color: 'white',
                padding: '4px 8px',
                borderRadius: '8px',
                fontSize: 11,
  ...
  return (
    <div className="content-wrapper" style={{ background: 'linear-gradient(135deg, #F7F4EF 0%, #E6E1D8 100%)', minHeight: '100vh' }}>
      <div className="page-header" style={{
        background: 'linear-gradient(135deg, #9B8E7E 0%, #7D7064 100%)',
        padding: '32px',
        borderRadius: '20px',
        boxShadow: '0 8px 32px rgba(155, 142, 126, 0.25)',
        marginBottom: '32px',
        textAlign: 'center',
        color: 'white',
      }}>
              ...
              <Space>
                <Button 
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, #9B8E7E 0%, #7D7064 100%)',
                    border: 'none',
                    boxShadow: '0 4px 12px rgba(155, 142, 126, 0.25)',
                  }}
                >
                  搜索
                </Button>
                ...
                >
                  <Option value="recommendation">
                    <span style={{ display: 'flex', alignItems: 'center' }}>
                      <StarOutlined style={{ marginRight: 8, color: '#8A9A8B' }} />
                      个性化推荐
                    </span>
                  </Option>
                  <Option value="popularity">
                    <span style={{ display: 'flex', alignItems: 'center' }}>
                      <FireOutlined style={{ marginRight: 8, color: '#C4A0A0' }} />
                      按热度排序 (Top-K优化)
                    </span>
                  </Option>
                  <Option value="rating">
                    <span style={{ display: 'flex', alignItems: 'center' }}>
                      <StarOutlined style={{ marginRight: 8, color: '#A8B8A0' }} />
                      按评价排序 (Top-K优化)
                    </span>
                  </Option>
                </Select>
                {(sortType === 'popularity' || sortType === 'rating') && (
                  <Tag 
                    ...
                    style={{ 
                      ...
                      fontSize: '12px',
                      fontWeight: 'bold',
                      background: 'linear-gradient(135deg, #A8B8A0 0%, #7D8F78 100%)',
                      border: 'none',
                      color: 'white',
                    }}
                  >
      ...
      <Spin spinning={loading} tip={loading ? "正在为您个性化推荐..." : ""}>
        ...
        {!loading && places.length === 0 && (
          <div style={{ 
            ...
            <EnvironmentOutlined style={{ fontSize: 64, color: '#B0A89C', marginBottom: 16 }} />
            <Title level={4} style={{ color: '#B0A89C', margin: 0 }}>
              {isSearchMode ? '未找到相关场所' : '暂无场所数据'}
            </Title>
            <Text style={{ color: '#B0A89C', fontSize: 14 }}>
        ...
        <div style={{
          ...
          <Pagination
            ...
            showTotal={(total, range) => (
              <span style={{ color: '#2D2926', fontSize: 14 }}>

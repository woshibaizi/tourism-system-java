                  ...
                  <td className="py-3 font-sans text-sm text-body">
                    <div className="flex items-center gap-2">
                      <div className="flex-1 h-1 bg-neutral-100">
                        <div className="h-full bg-neutral-900" style={{ width: `${Math.min(((u.clickCount || 0) / (activeUsers[0]?.clickCount || 1)) * 100, 100)}%` }} />
                      </div>
                      {u.clickCount || 0}
                    </div>
                  </td>
            ...
            {ratingDist.map((r) => (
              <div key={r.star} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-neutral-100">
                  <div className="h-full bg-neutral-900 transition-all" style={{ width: `${r.pct}%` }} />
                </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-3">
              {Object.entries(placeTypes).map(([type, count]) => (
                <span key={type} className="px-4 py-2 border border-neutral-200 font-sans text-sm">

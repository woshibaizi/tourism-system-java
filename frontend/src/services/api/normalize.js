...
export const normalizeRouteResponse = (payload = {}, fallback = {}) => {
  ...
  return {
    ...
    legPolylines: Array.isArray(payload.legPolylines) ? payload.legPolylines : [],

    ...
    >
      ...
      >
            ...
            return (
              <li key={item.key}>
                <button
                  ...
                  className={clsx(
                    'flex items-center gap-4 w-full py-3 px-4 font-serif tracking-wide text-xs transition-colors',
                    isActive
        ...
        <div className="px-8 mt-auto space-y-4">
          ...
          >
            <LogOut size={18} />
            <span className="font-serif tracking-wide text-xs">Logout</span>
          </button>
        </div>
      </motion.nav>
    </motion.div>

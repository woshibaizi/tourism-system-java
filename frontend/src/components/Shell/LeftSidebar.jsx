  ...
  return (
    ...
    >
      ...
      <div className={clsx('mt-auto border-t border-border', collapsed ? 'px-0' : 'px-4')}>
        ...
        >
          <User size={16} />
          {!collapsed && <span className="font-serif tracking-wide text-xs">{currentUser?.username || 'Profile'}</span>}
        </button>
        ...
        >
          <LogOut size={16} />
          {!collapsed && <span className="font-serif tracking-wide text-xs">退出</span>}
        </button>
      </div>
    </nav>
  );

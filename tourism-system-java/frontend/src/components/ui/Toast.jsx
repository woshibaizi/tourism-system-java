          ...
          {toasts.map((toast) => {
            ...
            return (
              <motion.div
                ...
                className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-sm border-l-4 shadow-lg bg-white min-w-[280px] max-w-[420px] ${colors[toast.type] || colors.info}`}
              >
                <Icon size={18} />

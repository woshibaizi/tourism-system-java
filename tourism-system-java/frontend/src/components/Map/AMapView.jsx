...
export default function AMapView({
  ...
  if (useFallback) {
    return (
      <div style={{ height: mapHeight }} className="bg-neutral-50 border border-neutral-200 flex items-center justify-center">
  ...
  return (
    <div className="relative">
      {loading && (
        <div style={{ height: mapHeight }} className="flex items-center justify-center bg-neutral-50 border border-neutral-200">
      ...
      {showControls && mapReady && (
        <div className="absolute top-3 right-3 flex flex-col gap-2 z-10">
          <button onClick={handleLocate} disabled={locating}
            className="w-9 h-9 bg-white border border-neutral-200 flex items-center justify-center hover:bg-neutral-50 shadow-sm">
          ...
          {animationEnabled && (
            <>
              ...
              <div className="bg-white border border-neutral-200 px-2 py-1 shadow-sm">

      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-6 mb-8 pb-8 border-b border-neutral-100">
          <div className="flex items-center gap-2 text-sm text-muted">
            <div className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center"><User size={14} className="text-muted" /></div>
        ...
        {tags.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-8 pb-8 border-b border-neutral-100">
            {tags.map((tag) => (
              <span key={tag} className="flex items-center gap-1 px-3 py-1 text-xs border border-neutral-200 font-sans text-muted">
                <TagIcon size={10} />{tag}
              </span>
            ))}
          </div>
